                ...
                <div class="col-sm-12 overflow">
                   <div class="social-icons pull-right">
                        <ul class="nav nav-pills">
                            ...
                            <li><a href="/?c=Users&a=index"><i>登陆/注册</i></a></li>
                        </ul>
                    </div> 
                </div>
             </div>
                     ...
                     <div class="col-md-12 col-sm-12">
                        <div class="single-blog blog-details two-column">
                            ...
                            <div class="post-content overflow">
                                <h2 class="post-title bold"><a href="#"><?php echo ($postDetail["title"]); ?></a></h2>
                                <h3 class="post-author"><a href="#"><?php echo ($postDetail["descirbe"]); ?></a></h3>
                                <p><?php echo ($postDetail["content"]); ?></p>
                                <div class="post-bottom overflow">
                                    <ul class="nav navbar-nav post-nav">
                                        <li><a><i class="fa fa-tag"></i><?php echo ($postDetail["view_count"]); ?> 查看</a></li>
                                        <li><a><i class="fa fa-heart"></i><?php echo ($postDetail["like_count"]); ?> 赞</a></li>
                                        <li><a href="#"><i class="fa fa-comments"></i><?php echo ($postDetail["comment_count"]); ?> 评论</a></li>
                                    </ul>
                                </div>
                                ...
                                <ul class="media-list">
                                    ...
                                    <?php if(is_array($commentArr)): $i = 0; $__LIST__ = $commentArr;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$v): $mod = ($i % 2 );++$i;?><li class="media">
                                            <div class="post-comment">
                                                <div class="media-body">
                                                    <span><i class="fa fa-user"></i>网友<a href="#"><?php echo ($v["comment_user_id"]); ?></a></span>
                                                    <p><?php echo ($v["comment_content"]); ?></p>
                                                    <ul class="nav navbar-nav post-nav">
                                                        <li><i class="fa fa-clock-o"></i><?php echo ($v["comment_date"]); ?></li>
                                                        <li><a href="#"><i class="fa fa-reply"></i>回复</a></li>
                                                    </ul>
                                                </div>
                                            </div>
