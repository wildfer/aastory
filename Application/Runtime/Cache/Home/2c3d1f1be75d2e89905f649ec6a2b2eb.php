            ...
            <div class="row">
                <div class="col-md-9 col-sm-7">
                    <div class="row">
                        ...
                        <?php if(is_array($postHotArr)): $i = 0; $__LIST__ = $postHotArr;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$postid): $mod = ($i % 2 );++$i;?><div class="col-sm-12 col-md-12">
                                <div class="single-blog single-column">
                                    <div class="post-thumb">
                                        <a href="/?c=Post&a=detail&postid=<?php echo ($postid["id"]); ?>"><img src="<?php echo ($postid["img_cover"]); ?>" class="img-responsive" alt=""></a>
                                        <!-- <div class="post-overlay">
                                           <span class="uppercase"><a href="#">14 <br><small>Feb</small></a></span>
                                       </div> -->
                                    </div>
                                     <div class="post-content overflow">
                                        <h2 class="post-title bold"><a href="/?c=Post&a=detail&postid=<?php echo ($postid["id"]); ?>"><?php echo ($postid["title"]); ?></a></h2>
                                        <h3 class="post-author"><a href="#">Posted by micron News</a></h3>
                                        <p><?php echo ($postid["describe"]); ?></p>
                                        <a href="#" class="read-more">View More</a>
                                        <div class="post-bottom overflow">
                                            <ul class="nav navbar-nav post-nav">
                                                <!--<li><a href="#"><i class="fa fa-tag"></i>Creative</a></li>-->
                                                <li><a href="#"><i class="fa fa-heart"></i>关注</a></li>
                                                <li><a href="#"><i class="fa fa-comments"></i>评论</a></li>
                                            </ul>
                                        </div>
                                    </div>
                                </div>
